...
UCY says: forget all of that. You don't need months. You have weeks. The Gregorian calendar layers two incompatible grids on top of each other - months that don’t contain whole weeks, weeks that don’t fit into months, neither of which divides evenly into the year. Two broken rulers measuring the same stretch of time. UCY throws both away and keeps one: the week. Weeks divide evenly into the year, and that's sufficient. If you want seasonal markers, use the equinoxes and solstices directly. If you need to refer to a time period longer than a week but shorter than a year, use week ranges. Week 20 through Week 30 is a perfectly serviceable way to describe a quarter-year period. It's more precise than "Q2" and more regular than "April through June."
